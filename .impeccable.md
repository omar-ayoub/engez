...
Think: the simplicity of a calculator app meets the trust of a banking
app. No visual clutter. No information overload. Every pixel earns its
place.

Reference feel: Wise (TransferWise) for calm finance UI, Linear for
minimal dark interfaces, WhatsApp for speed and familiarity in the
Egyptian market.
